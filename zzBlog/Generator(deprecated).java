...
public class Generator {
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/blog ");//指明是哪个数据库
        ...
        strategyConfig.setInclude("tb_article","tb_article_tag","tb_category","tb_chat_record","tb_comment","tb_friend_link",
                "tb_menu","tb_message","tb_operation_log","tb_resource","tb_role","tb_role_menu","tb_role_resource","tb_tag",
                "tb_unique_view","tb_user_auth","tb_user_info","tb_user_role");//调用的数据表
